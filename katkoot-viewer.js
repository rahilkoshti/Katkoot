...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),Kd>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),Kd++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new lo(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(Gd.has(e))return Gd.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:s,type:c,dfdFlags:l}}=e;if(n===`error`)return Promise.reject(r);let u;if(t.faceCount===6)u=new da(i,s,c);else{let e=i[0].mipmaps;u=t.layerCount>1?new ua(e,a,o,t.layerCount,s,c):new la(e,a,o,s,c)}return u.minFilter=i[0].mipmaps.length===1?g:v,u.magFilter=g,u.generateMipmaps=!1,u.needsUpdate=!0,u.colorSpace=ef(t),u.premultiplyAlpha=!!(l&1),u}async _createTexture(e,t={}){let n=Pd(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return $d(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return Gd.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),Kd--}};Jd.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},Jd.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},Jd.EngineFormat={RGBAFormat:P,RGBA_ASTC_4x4_Format:ye,RGB_BPTC_UNSIGNED_Format:z,RGBA_BPTC_Format:Me,RGBA_ETC2_EAC_Format:me,RGBA_PVRTC_4BPPV1_Format:ue,RGBA_S3TC_DXT5_Format:se,RGB_ETC1_Format:fe,RGB_ETC2_Format:pe,RGB_PVRTC_4BPPV1_Format:ce,RGBA_S3TC_DXT1_Format:oe},Jd.EngineType={UnsignedByteType:y,HalfFloatType:E,FloatType:T},Jd.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}})}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if((!s.if||e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&(!s.needsPowerOfTwo||f(n)&&f(r)))return{transcoderFormat:s.transcoderFormat[+!!i],engineFormat:s.engineFormat[+!!i],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2||!(e&e-1)&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var Yd=new Set([P,N,ne,I]),Xd=new Set([91]),Zd={109:P,103:ne,100:I,97:P,83:ne,76:I,91:P,43:P,37:P,22:ne,16:ne,15:I,9:I,123:N,122:N,152:me,148:pe,153:he,154:ge,155:_e,156:ve,[kd]:ye,158:ye,157:ye,[Ad]:Ce,166:Ce,165:Ce,134:oe,133:oe,132:ae,131:ae,138:se,137:se,140:B,139:Pe,142:Fe,141:V,146:Me,145:Me,[Od]:ue,[Ed]:ue,[Dd]:de,[Td]:de},Qd={109:T,103:T,100:T,97:E,83:E,76:E,91:S,43:y,37:y,22:y,16:y,15:y,9:y,123:A,122:j,152:y,148:y,153:y,154:y,155:y,156:y,[kd]:E,158:y,157:y,[Ad]:E,166:y,165:y,134:y,133:y,132:y,131:y,138:y,137:y,140:y,139:y,142:y,141:y,146:y,145:y,[Od]:y,[Ed]:y,[Dd]:y,[Td]:y};async function $d(e){let{vkFormat:t}=e;if(Zd[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);Qd[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(qd||(qd=new Promise(async e=>{let t=new zd;await t.init(),e(t)})),n=await qd);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=Qd[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):Qd[t]===1016||Qd[t]===1012?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):Qd[t]===35902||Qd[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let i=e.levelCount===0||r.length>1,a;if(Yd.has(Zd[t]))a=e.pixelDepth===0?new Ti(r[0].data,e.pixelWidth,e.pixelHeight):new nn(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),a.minFilter=i?m:p,a.magFilter=p,a.generateMipmaps=e.levelCount===0,a.normalized=Xd.has(t);else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`);a=new la(r,e.pixelWidth,e.pixelHeight),a.minFilter=i?v:g,a.magFilter=g}return a.mipmaps=r,a.type=Qd[t],a.format=Zd[t],a.colorSpace=ef(e),a.needsUpdate=!0,Promise.resolve(a)}function ef(e){let t=e.dataFormatDescriptor[0];return t.colorPrimaries===1?t.transferFunction===2?Ge:Ke:t.colorPrimaries===10?t.transferFunction===2?Vd:Hd:(t.colorPrimaries===0||console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${t.colorPrimaries}"`),``)}var tf={sensitivity:.004,damping:.95,follow:.08,cameraFollow:.06,autoRotateDelay:3e3,autoRotateSpeed:.002,tapThreshold:10,tapMaxTime:300,defaultTilt:Math.PI*120/180,zoomedTilt:Math.PI*120/180,initialRotationX:-.15,keyStep:.07,overviewY:.5,baseY:-3.5,baseDistance:.5},nf=(e,t,n)=>e+(t-e)*n,rf=(e,t,n)=>Math.min(n,Math.max(t,e)),af=typeof window.matchMedia==`function`?window.matchMedia(`(prefers-reduced-motion: reduce)`):null;function of(e){let{element:t,camera:n,pivot:r,model:i,baseCenter:a}=e,o=i.position.clone(),s=new K,c=new K,l=new es,u=new G,d={rotationX:tf.initialRotationX,rotationY:0,targetRotationX:tf.initialRotationX,targetRotationY:0,velocityX:0,velocityY:0,tiltLimit:tf.defaultTilt,scrollProgress:0,targetScrollProgress:0,inspectingBase:!1,overviewDistance:8,cameraY:tf.overviewY,targetCameraY:tf.overviewY,cameraDistance:8,targetCameraDistance:8,dragging:!1,lastInteraction:Date.now()},f=null,p={x:0,y:0},m=null,h=0,g=0,_=!1;function v(){let e=d.targetScrollProgress;d.targetCameraY=nf(tf.overviewY,tf.baseY,e),d.targetCameraDistance=nf(d.overviewDistance,tf.baseDistance,e),a&&c.copy(a).multiplyScalar(-e),d.inspectingBase=e>.3,d.tiltLimit=nf(tf.defaultTilt,tf.zoomedTilt,e)}function y(e){d.overviewDistance=e,v(),_||(_=!0,d.cameraY=d.targetCameraY,d.cameraDistance=d.targetCameraDistance,N())}let b=e=>({x:e.clientX,y:e.clientY});function x(){d.targetScrollProgress=1,d.targetRotationX=0,d.velocityX=0,d.velocityY=0,v()}function S(){d.targetScrollProgress=0,d.targetRotationX=0,d.velocityX=0,d.velocityY=0,v()}function C(e){if(d.inspectingBase){S();return}let r=t.getBoundingClientRect();u.x=(e.x-r.left)/r.width*2-1,u.y=-((e.y-r.top)/r.height)*2+1,l.setFromCamera(u,n),l.intersectObject(i,!0).length!==0&&x()}function w(e){if(!(e.ctrlKey||e.metaKey||e.altKey)){switch(e.key){case`ArrowLeft`:d.targetRotationY-=tf.keyStep;break;case`ArrowRight`:d.targetRotationY+=tf.keyStep;break;case`ArrowUp`:d.targetRotationX=rf(d.targetRotationX-tf.keyStep,-d.tiltLimit,d.tiltLimit);break;case`ArrowDown`:d.targetRotationX=rf(d.targetRotationX+tf.keyStep,-d.tiltLimit,d.tiltLimit);break;case`Enter`:case` `:d.inspectingBase?S():x();break;case`Escape`:if(!d.inspectingBase)return;S();break;default:return}e.preventDefault(),d.velocityX=0,d.velocityY=0,d.lastInteraction=Date.now()}}function T(e){if(f!==null)return;f=e.pointerId;let t=b(e);m=t,h=Date.now(),d.dragging=!0,d.velocityX=0,d.velocityY=0,p=t,d.lastInteraction=Date.now()}function E(e){if(!d.dragging||e.pointerId!==f)return;e.cancelable&&e.preventDefault();let t=b(e);d.velocityY=(t.x-p.x)*tf.sensitivity,d.velocityX=(t.y-p.y)*tf.sensitivity,d.targetRotationY+=d.velocityY,d.targetRotationX=rf(d.targetRotationX+d.velocityX,-d.tiltLimit,d.tiltLimit),p=t,d.lastInteraction=Date.now()}function D(e){if(f===null||e.pointerId===f){if(f=null,d.dragging=!1,m){let t=b(e);Math.hypot(t.x-m.x,t.y-m.y)<tf.tapThreshold&&Date.now()-h<tf.tapMaxTime&&C(t)}m=null}}function O(){f=null,d.dragging=!1,m=null}function k(e){(e.ctrlKey||e.metaKey)&&(e.preventDefault(),d.targetScrollProgress=rf(d.targetScrollProgress+e.deltaY*.001,0,1),v(),d.lastInteraction=Date.now())}function A(e){e.touches.length===2&&(d.dragging=!1,d.velocityX=0,d.velocityY=0,m=null,g=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY))}function j(e){if(e.touches.length!==2)return;e.cancelable&&e.preventDefault();let t=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY);d.targetScrollProgress=rf(d.targetScrollProgress-(t-g)*.002,0,1),v(),g=t,d.lastInteraction=Date.now()}t.addEventListener(`pointerdown`,T),window.addEventListener(`pointermove`,E,{passive:!1}),window.addEventListener(`pointerup`,D),window.addEventListener(`pointercancel`,O),t.addEventListener(`wheel`,k,{passive:!1}),t.addEventListener(`touchstart`,A,{passive:!0}),t.addEventListener(`touchmove`,j,{passive:!1}),t.addEventListener(`keydown`,w);function M(){t.removeEventListener(`pointerdown`,T),window.removeEventListener(`pointermove`,E),window.removeEventListener(`pointerup`,D),window.removeEventListener(`pointercancel`,O),t.removeEventListener(`wheel`,k),t.removeEventListener(`touchstart`,A),t.removeEventListener(`touchmove`,j),t.removeEventListener(`keydown`,w)}function N(){r.rotation.set(d.rotationX,d.rotationY,0),i.position.copy(o).add(s),n.position.set(0,d.cameraY,d.cameraDistance),n.lookAt(0,0,0)}function P(){d.dragging||(d.targetRotationY+=d.velocityY,d.targetRotationX=rf(d.targetRotationX+d.velocityX,-d.tiltLimit,d.tiltLimit),d.velocityX*=tf.damping,d.velocityY*=tf.damping,Math.abs(d.velocityX)<1e-5&&(d.velocityX=0),Math.abs(d.velocityY)<1e-5&&(d.velocityY=0),Date.now()-d.lastInteraction>tf.autoRotateDelay&&d.velocityY===0&&!(af&&af.matches)&&(d.targetRotationY+=tf.autoRotateSpeed)),d.rotationX+=(d.targetRotationX-d.rotationX)*tf.follow,d.rotationY+=(d.targetRotationY-d.rotationY)*tf.follow,d.cameraY+=(d.targetCameraY-d.cameraY)*tf.cameraFollow,d.cameraDistance+=(d.targetCameraDistance-d.cameraDistance)*tf.cameraFollow,d.scrollProgress+=(d.targetScrollProgress-d.scrollProgress)*tf.cameraFollow,s.lerp(c,tf.cameraFollow),N()}function F(e,t){d.rotationX=d.targetRotationX=e,d.rotationY=d.targetRotationY=t,d.velocityX=0,d.velocityY=0,d.lastInteraction=Date.now(),N()}return v(),N(),{update:P,setOverviewDistance:y,set:F,dispose:M,state:d}}var sf=Math.PI/180,cf={reflection:{top:.12,lights:[{rect:!0,az:128,w:2.5,el:5,h:60,soft:3,i:10,color:[1,1,1]},{rect:!0,az:-128,w:2.5,el:5,h:60,soft:3,i:10,color:[1,1,1]},{az:40,sx:7,el:8,sy:35,i:4.5,color:[1,1,1]}]},transmission:{top:0,lights:[{az:180,sx:9,el:1.5,sy:5.5,i:1.25,color:[1,.93,.72]},{az:180,sx:70,el:0,sy:50,i:.12,color:[1,.93,.72]}]},metal:{ambient:.05,top:.5,lights:[{box:!0,az:160,el:-72,w:22,h:14,soft:14,i:1.7,color:[1,1,1]},{box:!0,az:-40,el:-62,w:16,h:10,soft:16,i:.9,color:[1,1,1]},{box:!0,az:70,el:12,w:16,h:28,soft:16,i:3,color:[1,1,1]},{box:!0,az:-75,el:5,w:12,h:30,soft:16,i:2,color:[1,1,1]},{box:!0,az:10,el:-5,w:30,h:12,soft:25,i:.9,color:[1,1,1]},{rect:!0,az:150,w:3,el:5,h:60,soft:4,i:6,color:[1,1,1]},{rect:!0,az:-150,w:3,el:5,h:60,soft:4,i:6,color:[1,1,1]}]}};function lf(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function uf(e,t){return[-Math.sin(e*sf)*Math.cos(t*sf),Math.sin(t*sf),Math.cos(e*sf)*Math.cos(t*sf)]}function df(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function ff(e,t){let n=e/2,r=new Float64Array(e);for(let t=0;t<e;t++){let n=((t+.5)/e-.5)*2*Math.PI;r[t]=Math.atan2(-Math.cos(n),Math.sin(n))/sf}let i=new Float64Array(n);for(let e=0;e<n;e++)i[e]=((e+.5)/n-.5)*180;let a=t.lights.map(t=>{let a={L:t,columns:new Float64Array(e),rows:new Float64Array(n)};if(t.box){a.c=uf(t.az,t.el);let e=Math.abs(a.c[1])>.99?[1,0,0]:df([0,1,0],a.c),n=Math.hypot(e[0],e[1],e[2]);a.right=[e[0]/n,e[1]/n,e[2]/n],a.up=df(a.c,a.right);let r=(t.w+t.soft)*sf,i=(t.h+t.soft)*sf,o=Math.hypot(Math.tan(r),Math.tan(i));return a.minForward=r<Math.PI/2&&i<Math.PI/2?1/Math.sqrt(1+o*o):0,a}for(let n=0;n<e;n++){let e=r[n]-t.az;e>180&&(e-=360),e<-180&&(e+=360),a.columns[n]=t.rect?1-lf(t.w,t.w+t.soft,Math.abs(e)):-(e*e)/(2*t.sx*t.sx)}for(let e=0;e<n;e++){let n=i[e]-t.el;a.rows[e]=t.rect?1-lf(t.h,t.h+t.soft,Math.abs(n)):n*n/(2*t.sy*t.sy)}return a}),o=a.some(e=>e.L.box),s=Float64Array.from(r,e=>Math.sin(e*sf)),c=Float64Array.from(r,e=>Math.cos(e*sf)),l=new Uint16Array(e*n*4),f=yr.toHalfFloat,p=0;for(let r=0;r<n;r++){let n=i[r],u=(t.ambient||0)+lf(50,80,n)*t.top+lf(-50,-80,n)*(t.floor||0),d=Math.cos(n*sf),m=Math.sin(n*sf);for(let t=0;t<e;t++){let e=u,n=u,i=u,h=o?-s[t]*d:0,g=o?c[t]*d:0;for(let o=0;o<a.length;o++){let s=a[o],c=s.L,l;if(c.box){let e=h*s.c[0]+m*s.c[1]+g*s.c[2];if(e<=s.minForward)continue;let t=Math.abs(Math.atan2(h*s.right[0]+m*s.right[1]+g*s.right[2],e))/sf,n=Math.abs(Math.atan2(h*s.up[0]+m*s.up[1]+g*s.up[2],e))/sf;l=(1-lf(c.w,c.w+c.soft,t))*(1-lf(c.h,c.h+c.soft,n))*c.i}else if(c.rect){if(s.columns[t]===0)continue;l=s.columns[t]*s.rows[r]*c.i}else l=Math.exp(s.columns[t]-s.rows[r])*c.i;e+=l*c.color[0],n+=l*c.color[1],i+=l*c.color[2]}l[p++]=f(e),l[p++]=f(n),l[p++]=f(i),l[p++]=f(1)}}let m=new Ti(l,e,n,P,E);return m.mapping=303,m.colorSpace=Ke,m.minFilter=g,m.magFilter=g,m.wrapS=u,m.wrapT=d,m.generateMipmaps=!1,m.needsUpdate=!0,m}function pf(e,t,n){let r=ff(t,n),i=e.fromEquirectangular(r);return r.dispose(),i}var mf=`(function(){async function e(e,t,n,r,i){let a=(e,t)=>({w:e,h:t,s:e+2,d:new Float32Array((e+2)*(t+2))}),o=e=>{let{w:t,h:n,s:r,d:i}=e;for(let e=1;e<=t;e++)i[e]=i[e+r],i[(n+1)*r+e]=i[n*r+e];for(let e=0;e<=n+1;e++)i[e*r]=i[e*r+1],i[e*r+t+1]=i[e*r+t]},s=(e,t,n)=>{let{w:r,h:i,s:a}=e,s=e.d,c=t.d;for(let t=0;t<n*2;t++){o(e);for(let e=1;e<=i;e++)for(let n=e*a+1+(e+t&1),i=e*a+r;n<=i;n+=2)s[n]=(s[n-1]+s[n+1]+s[n-a]+s[n+a]-c[n])*.25}},c=(e,t)=>{let n=a(Math.max(1,e.w>>1),Math.max(1,e.h>>1)),r=n.d,i=e.d,s=e.s;t&&o(t);let c=t&&t.d;for(let e=1;e<=n.h*2;e++){let a=(e+1>>1)*n.s;for(let o=1,l=e*s+1;o<=n.w*2;o++,l++)r[a+(o+1>>1)]+=t?i[l]-(c[l-1]+c[l+1]+c[l-s]+c[l+s]-4*c[l]):i[l]}return n},l=(e,t,n)=>{o(e);let r=(e,t)=>{let n=new Int32Array(e+1),r=new Float32Array(e+1);for(let i=1;i<=e;i++){let e=(i-.5)/2+.5,a=Math.min(Math.floor(e),t);n[i]=a,r[i]=Math.min(e-a,1)}return{index:n,weight:r}},i=r(t.w,e.w),a=r(t.h,e.h),s=e.s,c=e.d,l=t.d;for(let e=1;e<=t.h;e++){let r=a.index[e]*s,o=a.weight[e];for(let a=1,u=e*t.s+1;a<=t.w;a++,u++){let e=r+i.index[a],t=i.weight[a],d=c[e]+(c[e+1]-c[e])*t,f=d+(c[e+s]+(c[e+s+1]-c[e+s])*t-d)*o;l[u]=n?l[u]+f:f}}},u=async(e,t,n)=>{if(e.w<=8||e.h<=8){s(e,t,20);return}s(e,t,2);let r=c(t,e),o=a(r.w,r.h);n<2&&await i(),await u(o,r,n+1),l(o,e,!0),n<2&&await i(),s(e,t,2)},d=/* @__PURE__ */ new Float32Array(256),f=/* @__PURE__ */ new Float32Array(256);for(let e=0;e<256;e++)d[e]=(e-128)/127,f[e]=1/Math.max((e-128)/127,.25);let p=t*n,m=new Float32Array(p),h=new Float32Array(p);for(let i=2;i<n-2;i++)for(let n=2,a=i*t+2,o=a*4;n<t-2;n++,a++,o+=4){let t=f[e[o+2]];m[a]=-d[e[o]]*t,h[a]=r*d[e[o+1]]*t}let g=a(t,n),_=g.d;for(let e=1;e<n-1;e++)for(let n=1,r=e*t+1,i=(e+1)*g.s+2;n<t-1;n++,r++,i++)_[i]=.5*(m[r+1]-m[r-1]+h[r+t]-h[r-t]);await i();let v=[g];for(;v[v.length-1].w>8&&v[v.length-1].h>8;)v.push(c(v[v.length-1]));let y=a(v[v.length-1].w,v[v.length-1].h);s(y,v[v.length-1],20);for(let e=v.length-2;e>=0;e--){let t=a(v[e].w,v[e].h);l(y,t,!1),y=t;for(let t=0;t<2;t++)await u(y,v[e],e)}await i();let b=Math.ceil(t/4),x=Math.ceil(n/4),S=b*x,C=new Float32Array(S).fill(-1/0),w=new Float32Array(S),T=m;for(let e=0;e<n;e++)for(let n=0,r=e*t,i=(e+1)*y.s+1;n<t;n++,r++,i++){T[r]=y.d[i];let t=(e>>2)*b+(n>>2);y.d[i]>C[t]&&(C[t]=y.d[i])}let E=Math.max(2,Math.round(b/90)),D=(e,t,n,r)=>{let i=n===1?x:b,a=n===1?b:x,o=n===1?b:1;for(let s=0;s<i;s++){let i=s*o;for(let o=0;o<a;o++){let s=r?-1/0:0,c=0;for(let t=Math.max(0,o-E),l=Math.min(a-1,o+E);t<=l;t++){let a=e[i+t*n];r?s=a>s?a:s:(s+=a,c++)}t[i+o*n]=r?s:s/c}}};D(C,w,1,!0),D(w,C,b,!0),D(C,w,1,!1),D(w,C,b,!1);let O=h;for(let e=0;e<n;e++){let n=Math.min(Math.max((e+.5)/4-.5,0),x-1),r=Math.floor(n),i=Math.min(r+1,x-1),a=n-r;for(let n=0,o=e*t;n<t;n++,o++){let e=Math.min(Math.max((n+.5)/4-.5,0),b-1),t=Math.floor(e),s=Math.min(t+1,b-1),c=e-t,l=C[r*b+t]+(C[r*b+s]-C[r*b+t])*c,u=C[i*b+t]+(C[i*b+s]-C[i*b+t])*c;O[o]=Math.max(0,l+(u-l)*a-T[o])}}await i();let k=0;for(let e=0;e<p;e++)O[e]>k&&(k=O[e]);let A=/* @__PURE__ */ new Uint32Array(1024),j=1023/(k||1);for(let e=0;e<p;e++)A[Math.floor(O[e]*j)]++;let M=(e,t)=>{let n=0;for(let e=t;e<1024;e++)n+=A[e];for(let r=t,i=0;r<1024;r++)if(i+=A[r],i>=n*e)return r;return 1023},N=(M(.5,Math.floor(M(.999,0)*.3))+.5)/j,P=new Uint8Array(p);for(let e=0;e<p;e++)P[e]=Math.min(255,Math.round(O[e]/N*200));return P}self.onmessage=async t=>{let{pixels:n,w:r,h:i,rowSign:a}=t.data;try{let t=await e(n,r,i,a,()=>null);self.postMessage({depth:t},[t.buffer])}catch(e){self.postMessage({error:String(e&&e.message||e)})}}})();`,hf=typeof self<`u`&&self.Blob&&new Blob([`(self.URL || self.webkitURL).revokeObjectURL(self.location.href);`,mf],{type:`text/javascript;charset=utf-8`});function gf(e){let t;try{if(t=hf&&(self.URL||self.webkitURL).createObjectURL(hf),!t)throw``;let n=new Worker(t,{name:e?.name});return n.addEventListener(`error`,()=>{(self.URL||self.webkitURL).revokeObjectURL(t)}),n}catch{return new Worker(`data:text/javascript;charset=utf-8,`+encodeURIComponent(mf),{name:e?.name})}}async function _f(e,t,n,r,i){let a=(e,t)=>({w:e,h:t,s:e+2,d:new Float32Array((e+2)*(t+2))}),o=e=>{let{w:t,h:n,s:r,d:i}=e;for(let e=1;e<=t;e++)i[e]=i[e+r],i[(n+1)*r+e]=i[n*r+e];for(let e=0;e<=n+1;e++)i[e*r]=i[e*r+1],i[e*r+t+1]=i[e*r+t]},s=(e,t,n)=>{let{w:r,h:i,s:a}=e,s=e.d,c=t.d;for(let t=0;t<n*2;t++){o(e);for(let e=1;e<=i;e++)for(let n=e*a+1+(e+t&1),i=e*a+r;n<=i;n+=2)s[n]=(s[n-1]+s[n+1]+s[n-a]+s[n+a]-c[n])*.25}},c=(e,t)=>{let n=a(Math.max(1,e.w>>1),Math.max(1,e.h>>1)),r=n.d,i=e.d,s=e.s;t&&o(t);let c=t&&t.d;for(let e=1;e<=n.h*2;e++){let a=(e+1>>1)*n.s;for(let o=1,l=e*s+1;o<=n.w*2;o++,l++)r[a+(o+1>>1)]+=t?i[l]-(c[l-1]+c[l+1]+c[l-s]+c[l+s]-4*c[l]):i[l]}return n},l=(e,t,n)=>{o(e);let r=(e,t)=>{let n=new Int32Array(e+1),r=new Float32Array(e+1);for(let i=1;i<=e;i++){let e=(i-.5)/2+.5,a=Math.min(Math.floor(e),t);n[i]=a,r[i]=Math.min(e-a,1)}return{index:n,weight:r}},i=r(t.w,e.w),a=r(t.h,e.h),s=e.s,c=e.d,l=t.d;for(let e=1;e<=t.h;e++){let r=a.index[e]*s,o=a.weight[e];for(let a=1,u=e*t.s+1;a<=t.w;a++,u++){let e=r+i.index[a],t=i.weight[a],d=c[e]+(c[e+1]-c[e])*t,f=d+(c[e+s]+(c[e+s+1]-c[e+s])*t-d)*o;l[u]=n?l[u]+f:f}}},u=async(e,t,n)=>{if(e.w<=8||e.h<=8){s(e,t,20);return}s(e,t,2);let r=c(t,e),o=a(r.w,r.h);n<2&&await i(),await u(o,r,n+1),l(o,e,!0),n<2&&await i(),s(e,t,2)},d=new Float32Array(256),f=new Float32Array(256);for(let e=0;e<256;e++)d[e]=(e-128)/127,f[e]=1/Math.max((e-128)/127,.25);let p=t*n,m=new Float32Array(p),h=new Float32Array(p);for(let i=2;i<n-2;i++)for(let n=2,a=i*t+2,o=a*4;n<t-2;n++,a++,o+=4){let t=f[e[o+2]];m[a]=-d[e[o]]*t,h[a]=r*d[e[o+1]]*t}let g=a(t,n),_=g.d;for(let e=1;e<n-1;e++)for(let n=1,r=e*t+1,i=(e+1)*g.s+2;n<t-1;n++,r++,i++)_[i]=.5*(m[r+1]-m[r-1]+h[r+t]-h[r-t]);await i();let v=[g];for(;v[v.length-1].w>8&&v[v.length-1].h>8;)v.push(c(v[v.length-1]));let y=a(v[v.length-1].w,v[v.length-1].h);s(y,v[v.length-1],20);for(let e=v.length-2;e>=0;e--){let t=a(v[e].w,v[e].h);l(y,t,!1),y=t;for(let t=0;t<2;t++)await u(y,v[e],e)}await i();let b=Math.ceil(t/4),x=Math.ceil(n/4),S=b*x,C=new Float32Array(S).fill(-1/0),w=new Float32Array(S),T=m;for(let e=0;e<n;e++)for(let n=0,r=e*t,i=(e+1)*y.s+1;n<t;n++,r++,i++){T[r]=y.d[i];let t=(e>>2)*b+(n>>2);y.d[i]>C[t]&&(C[t]=y.d[i])}let E=Math.max(2,Math.round(b/90)),D=(e,t,n,r)=>{let i=n===1?x:b,a=n===1?b:x,o=n===1?b:1;for(let s=0;s<i;s++){let i=s*o;for(let o=0;o<a;o++){let s=r?-1/0:0,c=0;for(let t=Math.max(0,o-E),l=Math.min(a-1,o+E);t<=l;t++){let a=e[i+t*n];r?s=a>s?a:s:(s+=a,c++)}t[i+o*n]=r?s:s/c}}};D(C,w,1,!0),D(w,C,b,!0),D(C,w,1,!1),D(w,C,b,!1);let O=h;for(let e=0;e<n;e++){let n=Math.min(Math.max((e+.5)/4-.5,0),x-1),r=Math.floor(n),i=Math.min(r+1,x-1),a=n-r;for(let n=0,o=e*t;n<t;n++,o++){let e=Math.min(Math.max((n+.5)/4-.5,0),b-1),t=Math.floor(e),s=Math.min(t+1,b-1),c=e-t,l=C[r*b+t]+(C[r*b+s]-C[r*b+t])*c,u=C[i*b+t]+(C[i*b+s]-C[i*b+t])*c;O[o]=Math.max(0,l+(u-l)*a-T[o])}}await i();let k=0;for(let e=0;e<p;e++)O[e]>k&&(k=O[e]);let A=new Uint32Array(1024),j=1023/(k||1);for(let e=0;e<p;e++)A[Math.floor(O[e]*j)]++;let M=(e,t)=>{let n=0;for(let e=t;e<1024;e++)n+=A[e];for(let r=t,i=0;r<1024;r++)if(i+=A[r],i>=n*e)return r;return 1023},N=(M(.5,Math.floor(M(.999,0)*.3))+.5)/j,P=new Uint8Array(p);for(let e=0;e<p;e++)P[e]=Math.min(255,Math.round(O[e]/N*200));return P}var vf=1400;async function yf(e){let t=e.image;if(!t||!t.width||!t.height)throw Error(`normal map has no image`);let n=Math.max(0,Math.ceil(Math.log2(Math.max(t.width,t.height)/vf))),r=Math.max(1,t.width>>n),i=Math.max(1,t.height>>n),a=new Ti(await xf(await bf(t,r,i),r,i,e.flipY?-1:1,()=>bf(t,r,i)),r,i,I,y);return a.wrapS=d,a.wrapT=d,a.magFilter=g,a.minFilter=v,a.generateMipmaps=!0,a.anisotropy=8,a.needsUpdate=!0,a}async function bf(e,t,n){let r=e,i=null;if(typeof createImageBitmap==`function`&&typeof ImageBitmap<`u`&&e instanceof ImageBitmap)try{i=await createImageBitmap(e,{colorSpaceConversion:`none`,premultiplyAlpha:`none`,resizeWidth:t,resizeHeight:n,resizeQuality:`high`}),r=i}catch{}let a=(typeof OffscreenCanvas==`function`?new OffscreenCanvas(t,n):Object.assign(document.createElement(`canvas`),{width:t,height:n})).getContext(`2d`,{willReadFrequently:!0,colorSpace:`srgb`});if(!a)throw Error(`no 2d context`);a.imageSmoothingEnabled=!0,a.imageSmoothingQuality=`high`,a.drawImage(r,0,0,t,n);let o=a.getImageData(0,0,t,n).data;return i&&i.close(),new Uint8Array(o.buffer,o.byteOffset,t*n*4)}function xf(e,t,n,r,i){return new Promise((a,o)=>{let s=()=>{Promise.resolve(e.byteLength>0?e:i()).then(e=>_f(e,t,n,r,()=>new Promise(e=>setTimeout(e,0)))).then(a,o)},c;try{c=new gf}catch{s();return}c.onmessage=e=>{c.terminate(),e.data.error?s():a(e.data.depth)},c.onerror=()=>{c.terminate(),s()},c.postMessage({pixels:e,w:t,h:n,rowSign:r},[e.buffer])})}var Sf={satinRoughness:.5,satinShade:.65,tarnish:`#c49a78`,tarnishAmount:.7,wave:.12,engravingFloorShade:.45,engravingFloorRoughness:.15,engravingBevel:.3,engravingBevelHighlight:1.5,engravingAA:1,bevelTexels:1.5,bevelSlope:6,bevelBakeSize:[1132,1362],bevelDensity:.848};function Cf(e,t,n){let r=e.material,i=!r.normalMap,a=new Ti(new Uint8Array([0]),1,1,I);a.needsUpdate=!0;let o={metalWorldToModel:{value:new Y},metalModelToView:{value:new q},metalUpView:{value:new K(0,1,0)},metalSatin:{value:+!!i},metalSatinRoughness:{value:Sf.satinRoughness},metalSatinShade:{value:Sf.satinShade},metalTarnish:{value:new X(Sf.tarnish)},metalTarnishAmount:{value:Sf.tarnishAmount},metalWave:{value:Sf.wave},metalDepthMap:{value:a},metalDepthTexel:{value:new G(Sf.bevelTexels/Sf.bevelBakeSize[0],Sf.bevelTexels/Sf.bevelBakeSize[1])},metalDepthDensity:{value:Sf.bevelDensity},metalDepthReady:{value:0},metalBevel:{value:Sf.engravingBevel},metalBevelSlope:{value:Sf.bevelSlope},metalBevelHighlight:{value:Sf.engravingBevelHighlight},metalFloorShade:{value:Sf.engravingFloorShade},metalFloorRoughness:{value:Sf.engravingFloorRoughness},metalEngravingAA:{value:Sf.engravingAA}},s=new q,c=new Y;e.onBeforeRender=(e,n,r)=>{let i=t.scale.x;o.metalWorldToModel.value.copy(t.matrixWorld).invert(),o.metalWorldToModel.value.premultiply(c.makeScale(i,i,i)),o.metalModelToView.value.setFromMatrix4(t.matrixWorld).multiplyScalar(1/i),o.metalModelToView.value.premultiply(s.setFromMatrix4(r.matrixWorldInverse)),o.metalUpView.value.set(0,1,0).transformDirection(r.matrixWorldInverse)},n(r,e=>{Object.assign(e.uniforms,o),e.vertexShader=e.vertexShader.replace(`#include <common>`,`
            ...
            `)},`metalFinish`),r.needsUpdate=!0;let l=!1;return{uniforms:o,setEngravingDepth(e){if(l){e.dispose();return}o.metalDepthMap.value!==a&&o.metalDepthMap.value.dispose(),o.metalDepthMap.value=e,o.metalDepthReady.value=1},dispose(){l||(l=!0,o.metalDepthMap.value!==a&&o.metalDepthMap.value.dispose(),a.dispose(),e.onBeforeRender=()=>{})}}}var wf={tint:`#a3c790`,tintDistance:.45,roughness:.18,ior:1.5,volumeIor:1.5,distance:.85},Tf={color:`#f2cea2`,roughness:.14,engravingStrength:2.5,envIntensity:1.33},Ef={brightness:6},Df=``,Of=1.25;function kf(e,t,n){let r=[];e.traverse(e=>{e.isMesh&&r.push(e)});let i=[];for(let a of r){let r=a.material;r&&(r.transmission>0?Af(a,t):/base/i.test(r.name)?i.push(jf(a,e,t,n)):r.map&&Mf(a,t),Nf(a.material))}return{finishes:i,dispose(){for(let e of i)e.dispose()}}}function Af(e,t){let n=e.material;n.transmission=0,n.transparent=!1,n.metalness=0,n.roughness=wf.roughness,n.ior=wf.ior,n.color=new X(0),n.side=0,n.envMap=t.reflection,n.envMapIntensity=1;let r=wf.distance,i={glassRefraction:{value:t.transmission},glassAttenuation:{value:new X(wf.tint)},glassAttenuationDistance:{value:wf.tintDistance},glassDistance:{value:r},glassVolumeIor:{value:wf.volumeIor},glassDebug:{value:0}};Pf(n,e=>{Object.assign(e.uniforms,i),e.fragmentShader=e.fragmentShader.replace(`#include <lights_physical_fragment>`,`
                #include <lights_physical_fragment>
                {
            ...
            `)},`glass`),n.needsUpdate=!0}function jf(e,t,n,r){let i=e.material;i.color=new X(Tf.color),i.metalness=1,i.roughness=Tf.roughness,i.envMap=n.metal,i.envMapIntensity=Tf.envIntensity,i.normalMap&&(i.normalMap.anisotropy=8,i.normalScale=new G(Tf.engravingStrength,Tf.engravingStrength)),i.needsUpdate=!0;let a=Cf(e,t,Pf),o=i.userData&&i.userData.katkootDepthTexture;return r&&typeof o==`number`?r.getDependency(`texture`,o).then(e=>{e.anisotropy=8,a.setEngravingDepth(e)}).catch(e=>console.warn(`[katkoot] engraving depth texture skipped:`,e)):i.normalMap&&yf(i.normalMap).then(e=>a.setEngravingDepth(e)).catch(e=>console.warn(`[katkoot] engraving depth bake skipped:`,e)),a}function Mf(e,t){e.material.envMap=t.reflection,e.material.envMapIntensity=Ef.brightness,e.material.needsUpdate=!0}function Nf(e){Pf(e,e=>{e.uniforms.viewerContrast={value:Of},e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
uniform float viewerContrast;`).replace(`#include <colorspace_fragment>`,`
            ...
            `)},`contrast`),e.needsUpdate=!0}function Pf(e,t,n){let r=e.onBeforeCompile;e.onBeforeCompile=(e,n)=>{r&&r(e,n),t(e,n)};let i=(e.userData.patchKey||``)+`|`+n;e.userData.patchKey=i,e.customProgramCacheKey=()=>i}var Ff=!1;function If(){return window.matchMedia(`(hover: none) and (pointer: coarse)`).matches}var Lf={maxPixelsTouch:16e5,maxPixelsDesktop:4e6,framing:1.25,modelScale:4,modelRotation:[Math.PI/2,-.015,Math.PI*2/180]};function Rf(e){let t=e&&e.container;if(!t)throw Error(`createViewer needs a container element`);let n=e.modelUrl;if(!n)throw Error(`createViewer needs a modelUrl`);let r=If()?Lf.maxPixelsTouch:Lf.maxPixelsDesktop,i=!If(),a=t.querySelector(`[data-katkoot-status]`)||t.querySelector(`#status-text`),o=t.querySelector(`#hud`);o&&o.remove();let s=!1,c=!1,l=!1,u=!0;function d(){s||c||(s=!0,t.classList.add(`is-ready`))}function f(e,n){s||c||(s=!0,t.classList.add(`is-failed`),a&&(a.textContent=e),n&&console.error(`[katkoot]`,e,n))}function p(e){!s&&a&&(a.textContent=e)}if(!ie())return f(`3D view unavailable`),{dispose(){}};let m=new xu({antialias:i,alpha:!0,powerPreference:`high-performance`});m.setClearColor(0,0),m.setSize(1,1,!1),m.outputColorSpace=Ge,m.toneMapping=4,m.toneMappingExposure=.6,m.debug.checkShaderErrors=Ff,t.appendChild(m.domElement);let h=m.domElement;h.setAttribute(`role`,`img`),h.setAttribute(`aria-label`,e.label||t.dataset.label||`Interactive 3D model of the bottle. Use the arrow keys to turn it, Enter to look at the base, Escape to come back.`),h.tabIndex=0;function g(e){e.preventDefault(),!c&&(l=!0,ne(),s=!1,t.classList.remove(`is-ready`),f(`3D view unavailable`))}function _(){c||(l=!1,T(),t.classList.remove(`is-failed`),s=!1,E&&d(),ne(),m.render(v,y))}h.addEventListener(`webglcontextlost`,g),h.addEventListener(`webglcontextrestored`,_);let v=new zn;v.background=null;let y=new Eo(45,1,.1,1e3),b=new jn;v.add(b);let x=null,S={reflection:null,metal:null},C=ff(512,cf.transmission),w={reflection:null,metal:null,transmission:C};function T(){let e={...S},t=new Os(m);t.compileEquirectangularShader(),S.reflection=pf(t,1024,cf.reflection),S.metal=pf(t,512,cf.metal),t.dispose();let n=new Map;for(let t of[`reflection`,`metal`])e[t]&&n.set(e[t].texture,S[t].texture),w[t]=S[t].texture;v.environment=w.reflection,n.size!==0&&(v.traverse(e=>{if(e.isMesh)for(let t of[].concat(e.material))t&&n.has(t.envMap)&&(t.envMap=n.get(t.envMap))}),e.reflection.dispose(),e.metal.dispose())}T(),performance.now();let E=null,D=null,O=null,k=null,A=new Jd().detectSupport(m);new Tu().setKTX2Loader(A).load(n,e=>{if(c){zf(e.scene);return}E=e.scene,b.add(E),F()&&(y.aspect=h.clientWidth/h.clientHeight),j(E),P(),k=kf(E,w,e.parser),m.compileAsync(v,y).then(()=>{c||(m.render(v,y),d())}).catch(e=>f(`3D view unavailable`,e))},e=>{e.total&&p(Math.round(e.loaded/e.total*100)+`%`)},e=>f(`3D view unavailable`,e));function j(e){let t=new er().setFromObject(e),n=t.getSize(new K),r=t.getCenter(new K),i=Lf.modelScale/Math.max(n.x,n.y,n.z);e.scale.multiplyScalar(i),e.position.sub(r.multiplyScalar(i)),e.rotation.set(...Lf.modelRotation),e.updateMatrixWorld(!0),e.position.sub(new er().setFromObject(e).getCenter(new K)),e.updateMatrixWorld(!0),D=new er().setFromObject(e).getSize(new K),O=M(e),N()}function M(e){let t=new er;return e.traverse(e=>{e.isMesh&&(/base/i.test(e.name)||/base/i.test(e.material?.name||``))&&t.union(new er().setFromObject(e))}),t.isEmpty()?null:t.getCenter(new K)}function N(){let e=y.fov*Math.PI/180,t=2*Math.atan(Math.tan(e/2)*y.aspect),n=Lf.framing*Math.max(D.y/2/Math.tan(e/2),Math.max(D.x,D.z)/2/Math.tan(t/2));y.updateProjectionMatrix(),x?x.setOverviewDistance(n):(y.position.set(0,tf.overviewY,n),y.lookAt(0,0,0))}function P(){x=of({element:h,camera:y,pivot:b,model:E,baseCenter:O}),N()}function F(){let e=window.devicePixelRatio||1,t=Math.floor(h.clientWidth*e),n=Math.floor(h.clientHeight*e);if(t===0||n===0)return!1;let i=t*n;if(i>r){let e=Math.sqrt(r/i);t=Math.floor(t*e),n=Math.floor(n*e)}return h.width===t&&h.height===n?!1:(m.setSize(t,n,!1),!0)}function ee(){F()&&(y.aspect=h.clientWidth/h.clientHeight,y.updateProjectionMatrix(),D&&N()),x&&x.update(),m.render(v,y)}let I=!1,te=null;function ne(){let e=u&&!l&&!c;e!==I&&(I=e,m.setAnimationLoop(e?ee:null))}typeof IntersectionObserver==`function`?(te=new IntersectionObserver(e=>{u=e.some(e=>e.isIntersecting),ne()},{threshold:0}),te.observe(t)):ne();function re(){c||(c=!0,te&&te.disconnect(),m.setAnimationLoop(null),I=!1,x&&x.dispose(),k&&k.dispose(),A.dispose(),h.removeEventListener(`webglcontextlost`,g),h.removeEventListener(`webglcontextrestored`,_),zf(v),v.environment=null,S.reflection.dispose(),S.metal.dispose(),C.dispose(),m.dispose(),m.forceContextLoss(),h.parentNode&&h.parentNode.removeChild(h),t.classList.remove(`is-ready`,`is-failed`))}function ie(){try{return!!document.createElement(`canvas`).getContext(`webgl2`)}catch{return!1}}return{dispose:re,renderer:m,scene:v,camera:y,pivot:b,getModel:()=>E,getControls:()=>x,getLook:()=>k,isRunning:()=>I,setView:(e=0,t=0)=>x&&x.set(e,t)}}function zf(e){e.traverse(e=>{if(e.isMesh){e.geometry&&e.geometry.dispose();for(let t of[].concat(e.material))if(t){for(let e of Object.keys(t)){let n=t[e];n&&n.isTexture&&n.dispose()}t.dispose()}}})}var Bf=`KxCHBottle15-ktx2.glb`;function Vf(e,t){return Rf({container:e,modelUrl:t||e.dataset.model||Hf()})}function Hf(){return new URL(Bf,import.meta.url).href}var Uf=document.querySelector(`[data-katkoot-viewer]`)||document.getElementById(`viewer`),Wf=null;Uf&&(Wf=Vf(Uf)),window.KatkootViewer={mount:Vf,createViewer:Rf,get current(){return Wf}};
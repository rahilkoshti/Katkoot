...
uniform float viewerContrast;`).replace(`#include <colorspace_fragment>`,`
            ...
            `)},`contrast`),e.needsUpdate=!0)}function zf(e,t,n){let r=e.onBeforeCompile;e.onBeforeCompile=(e,n)=>{r&&r(e,n),t(e,n)};let i=(e.userData.patchKey||``)+`|`+n;e.userData.patchKey=i,e.customProgramCacheKey=()=>i}var Bf=!1;function Vf(){return window.matchMedia(`(hover: none) and (pointer: coarse)`).matches}var Hf={maxPixelsTouch:16e5,maxPixelsDesktop:4e6,framing:1.25,modelScale:4,modelRotation:[Math.PI/2,-.015,Math.PI*2/180]};function Uf(e){let t=e&&e.container;if(!t)throw Error(`createViewer needs a container element`);let n=e.modelUrl;if(!n)throw Error(`createViewer needs a modelUrl`);let r=hf[e.look]?e.look:`dark`,i=hf[r],a=Vf()?Hf.maxPixelsTouch:Hf.maxPixelsDesktop,o=!Vf(),s=t.querySelector(`[data-katkoot-status]`)||t.querySelector(`#status-text`),c=t.querySelector(`#hud`);c&&c.remove();let l=!1,u=!1,d=!1,f=!0;function p(){l||u||(l=!0,t.classList.add(`is-ready`))}function m(e,n){l||u||(l=!0,t.classList.add(`is-failed`),s&&(s.textContent=e),n&&console.error(`[katkoot]`,e,n))}function h(e){!l&&s&&(s.textContent=e)}if(!le())return m(`3D view unavailable`),{dispose(){}};let g=new xu({antialias:o,alpha:!0,powerPreference:`high-performance`});g.setClearColor(0,0),g.setSize(1,1,!1),g.outputColorSpace=Ge,g.toneMapping=4,g.toneMappingExposure=.6,g.debug.checkShaderErrors=Bf,t.appendChild(g.domElement);let _=g.domElement;_.setAttribute(`role`,`img`),_.setAttribute(`aria-label`,e.label||t.dataset.label||`Interactive 3D model of the bottle. Use the arrow keys to turn it, Enter to look at the base, Escape to come back.`),_.tabIndex=0;function v(e){e.preventDefault(),!u&&(d=!0,L(),l=!1,t.classList.remove(`is-ready`),m(`3D view unavailable`))}function y(){u||(d=!1,D(),t.classList.remove(`is-failed`),l=!1,k&&p(),L(),g.render(b,x))}_.addEventListener(`webglcontextlost`,v),_.addEventListener(`webglcontextrestored`,y);let b=new zn;b.background=null;let x=new Eo(45,1,.1,1e3),S=new jn;b.add(S);let C=null,w={reflection:null,metal:null},T=pf(512,i.transmission),E={reflection:null,metal:null,transmission:T};function D(){let e={...w},t=new Os(g);t.compileEquirectangularShader(),w.reflection=mf(t,1024,i.reflection),w.metal=mf(t,512,i.metal),t.dispose();let n=new Map;for(let t of[`reflection`,`metal`])e[t]&&n.set(e[t].texture,w[t].texture),E[t]=w[t].texture;b.environment=E.reflection,n.size!==0&&(b.traverse(e=>{if(e.isMesh)for(let t of[].concat(e.material))t&&n.has(t.envMap)&&(t.envMap=n.get(t.envMap))}),e.reflection.dispose(),e.metal.dispose())}D();let O=performance.now(),k=null,A={started:O},j=O;function M(e){let t=performance.now();A[e]=Math.round(t-j),A.total=Math.round(t-O),j=t,window.__katkootTiming=A}let N=null,P=null,F=null,ee=new Jd().detectSupport(g);new Tu().setKTX2Loader(ee).setMeshoptDecoder(tf).load(n,e=>{if(u){Wf(e.scene);return}M(`fetchParseTranscode`),k=e.scene,S.add(k),ae()&&(x.aspect=_.clientWidth/_.clientHeight),te(k),ie(),F=Mf(k,E,e.parser,r),M(`applyLook`),h(`Preparing`),g.compileAsync(b,x).then(()=>{u||(M(`compileShaders`),g.render(b,x),M(`firstRender`),console.log(`[katkoot] timing`,JSON.stringify(A)),p())}).catch(e=>m(`3D view unavailable`,e))},e=>{e.total&&h(Math.round(e.loaded/e.total*100)+`%`),e.total&&e.loaded>=e.total&&!A.download&&(M(`download`),h(`Decoding`))},e=>m(`3D view unavailable`,e));function te(e){let t=new er().setFromObject(e),n=t.getSize(new K),r=t.getCenter(new K),i=Hf.modelScale/Math.max(n.x,n.y,n.z);e.scale.multiplyScalar(i),e.position.sub(r.multiplyScalar(i)),e.rotation.set(...Hf.modelRotation),e.updateMatrixWorld(!0),e.position.sub(new er().setFromObject(e).getCenter(new K)),e.updateMatrixWorld(!0),N=new er().setFromObject(e).getSize(new K),P=ne(e),re()}function ne(e){let t=new er;return e.traverse(e=>{e.isMesh&&(/base/i.test(e.name)||/base/i.test(e.material?.name||``))&&t.union(new er().setFromObject(e))}),t.isEmpty()?null:t.getCenter(new K)}function re(){let e=x.fov*Math.PI/180,t=2*Math.atan(Math.tan(e/2)*x.aspect),n=Hf.framing*Math.max(N.y/2/Math.tan(e/2),Math.max(N.x,N.z)/2/Math.tan(t/2));x.updateProjectionMatrix(),C?C.setOverviewDistance(n):(x.position.set(0,nf.overviewY,n),x.lookAt(0,0,0))}function ie(){C=sf({element:_,camera:x,pivot:S,model:k,baseCenter:P}),re()}function ae(){let e=window.devicePixelRatio||1,t=Math.floor(_.clientWidth*e),n=Math.floor(_.clientHeight*e);if(t===0||n===0)return!1;let r=t*n;if(r>a){let e=Math.sqrt(a/r);t=Math.floor(t*e),n=Math.floor(n*e)}return _.width===t&&_.height===n?!1:(g.setSize(t,n,!1),!0)}function oe(){ae()&&(x.aspect=_.clientWidth/_.clientHeight,x.updateProjectionMatrix(),N&&re()),C&&C.update(),g.render(b,x)}let se=!1,I=null;function L(){let e=f&&!d&&!u;e!==se&&(se=e,g.setAnimationLoop(e?oe:null))}typeof IntersectionObserver==`function`?(I=new IntersectionObserver(e=>{f=e.some(e=>e.isIntersecting),L()},{threshold:0}),I.observe(t)):L();function ce(){u||(u=!0,I&&I.disconnect(),g.setAnimationLoop(null),se=!1,C&&C.dispose(),F&&F.dispose(),ee.dispose(),_.removeEventListener(`webglcontextlost`,v),_.removeEventListener(`webglcontextrestored`,y),Wf(b),b.environment=null,w.reflection.dispose(),w.metal.dispose(),T.dispose(),g.dispose(),g.forceContextLoss(),_.parentNode&&_.parentNode.removeChild(_),t.classList.remove(`is-ready`,`is-failed`))}function le(){try{return!!document.createElement(`canvas`).getContext(`webgl2`)}catch{return!1}}return{dispose:ce,renderer:g,scene:b,camera:x,pivot:S,look:r,getModel:()=>k,getControls:()=>C,getLook:()=>F,get timing(){return A},isRunning:()=>se,setView:(e=0,t=0)=>C&&C.set(e,t)}}function Wf(e){e.traverse(e=>{if(e.isMesh){e.geometry&&e.geometry.dispose();for(let t of[].concat(e.material))if(t){for(let e of Object.keys(t)){let n=t[e];n&&n.isTexture&&n.dispose()}t.dispose()}}})}var Gf=`KxCHBottle15-min.glb`;function Kf(e,t,n){return Uf({container:e,modelUrl:t||e.dataset.model||Jf(),look:n||e.dataset.look||qf()})}function qf(){return`dark`}function Jf(){return new URL(Gf,import.meta.url).href}var Yf=document.querySelector(`[data-katkoot-viewer]`)||document.getElementById(`viewer`),Xf=null;Yf&&(Xf=Kf(Yf)),window.KatkootViewer={mount:Kf,createViewer:Uf,get current(){return Xf}};